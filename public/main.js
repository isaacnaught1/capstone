...
const intkBtn = document.getElementById('submit-questions')
...
const createAnswers = (arr) => {
    ...
    arr.forEach((answerObj,index) => {
        ...
        listItem.innerHTML = `<p>question: ${question} fortune:${answer}</p> 
...
intkBtn.addEventListener('click', randomAnswer)

saveButton.addEventListener('click', saveAnswer)

seeAllBtn.addEventListener('click', seeAnswers)
